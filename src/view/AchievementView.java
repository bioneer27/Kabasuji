...
public class AchievementView extends JFrame {
	...
	public void initialize(){
		...
		lblNewLabel.setToolTipText(model.getBadge(1).getDescription());
		...
		label.setToolTipText(model.getBadge(2).getDescription());
		...
		label_1.setToolTipText(model.getBadge(3).getDescription());
		...
		label_2.setToolTipText(model.getBadge(4).getDescription());
		...
		label_3.setToolTipText(model.getBadge(5).getDescription());
		...
		label_4.setToolTipText(model.getBadge(6).getDescription());
		...
		label_5.setToolTipText(model.getBadge(7).getDescription());
		...
		label_6.setToolTipText(model.getBadge(8).getDescription());
		...
		label_7.setToolTipText(model.getBadge(9).getDescription());
		...
		label_8.setToolTipText(model.getBadge(10).getDescription());
