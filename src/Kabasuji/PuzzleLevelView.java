	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				LevelPlayView view = new LevelPlayView(1, PieceType.PUZZLE);
		...
		lblNewLabel_1.setIcon(new ImageIcon(PuzzleLevelView.class.getResource("/Images/NotStarIcon.png")));
		
		JLabel label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon(PuzzleLevelView.class.getResource("/Images/NotStarIcon.png")));
		
		JLabel label_2 = new JLabel("");
		label_2.setIcon(new ImageIcon(PuzzleLevelView.class.getResource("/Images/NotStarIcon.png")));
		...
		lblPuzzle.setBackground(new Color(205, 92, 92));
		
		JButton btnNewButton_1 = new JButton("");
		btnNewButton_1.setIcon(new ImageIcon(PuzzleLevelView.class.getResource("/Images/BackIcon.png")));
