...
public class LightningPlayView2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LightningPlayView2 frame = new LightningPlayView2();
	...
	public LightningPlayView2() {
		...
		lblNewLabel.setIcon(new ImageIcon(LightningPlayView2.class.getResource("/Images/NotStarIcon.png")));
		
		JLabel label = new JLabel("Star 1");
		label.setIcon(new ImageIcon(LightningPlayView2.class.getResource("/Images/NotStarIcon.png")));
		...
		button_73.setBackground(Color.LIGHT_GRAY);
		Box1.add(button_73);
		...
		button_125.setBackground(Color.LIGHT_GRAY);
		Box1.add(button_125);
		...
		button_155.setBackground(Color.YELLOW);
		Box1.add(button_155);
		...
		button_158.setBackground(Color.YELLOW);
		Box1.add(button_158);
		...
		btnNewButton_5.setBackground(new Color(255, 250, 205));
		...
		btnNewButton_7.setBackground(new Color(255, 250, 205));
		...
		button_5.setBackground(new Color(255, 250, 205));
		...
		button_14.setBackground(new Color(255, 250, 205));
		...
		button_15.setBackground(new Color(255, 250, 205));
		...
		button_28.setBackground(new Color(255, 250, 205));
		...
		button_46.setBackground(new Color(255, 250, 205));
		...
		button_60.setBackground(new Color(255, 250, 205));
		...
		button_61.setBackground(new Color(255, 250, 205));
		...
		button_66.setBorderPainted(false);
		button_66.setBackground(new Color(255, 250, 205));
		button_66.setForeground(Color.YELLOW);
		BoardPanel.add(button_66);
		
		JButton button_67 = new JButton("");
		button_67.setBorderPainted(false);
		button_67.setBackground(new Color(255, 250, 205));
		...
		button_75.setBorder(null);
		button_75.setBorderPainted(false);
		button_75.setBackground(new Color(255, 250, 205));
		...
		button_80.setBorderPainted(false);
		button_80.setBackground(new Color(255, 250, 205));
		button_80.setForeground(Color.YELLOW);
		BoardPanel.add(button_80);
		
		JButton button_81 = new JButton("");
		button_81.setBorderPainted(false);
		button_81.setBackground(new Color(255, 250, 205));
		...
		button_95.setBorderPainted(false);
		button_95.setBackground(new Color(255, 250, 205));
		...
		button_119.setBorderPainted(false);
		button_119.setBackground(new Color(255, 250, 205));
		button_119.setForeground(Color.YELLOW);
		BoardPanel.add(button_119);
		
		JButton button_120 = new JButton("");
		button_120.setBorderPainted(false);
		button_120.setBackground(new Color(255, 250, 205));
		button_120.setForeground(Color.YELLOW);
		BoardPanel.add(button_120);
		
		JButton button_121 = new JButton("");
		button_121.setBorderPainted(false);
		button_121.setBackground(new Color(255, 250, 205));
		...
		button_133.setBorderPainted(false);
		button_133.setBackground(new Color(255, 250, 205));
		button_133.setForeground(Color.YELLOW);
		BoardPanel.add(button_133);
		
		JButton button_134 = new JButton("");
		button_134.setBorderPainted(false);
		button_134.setBackground(new Color(255, 250, 205));
		button_134.setForeground(Color.YELLOW);
		BoardPanel.add(button_134);
		
		JButton button_135 = new JButton("");
		button_135.setBorderPainted(false);
		button_135.setBackground(new Color(255, 250, 205));
		...
		button_147.setBorderPainted(false);
		button_147.setBackground(new Color(255, 250, 205));
		button_147.setForeground(Color.YELLOW);
		BoardPanel.add(button_147);
		
		JButton button_148 = new JButton("");
		button_148.setBorderPainted(false);
		button_148.setBackground(new Color(255, 250, 205));
		button_148.setForeground(Color.YELLOW);
		BoardPanel.add(button_148);
		
		JButton button_149 = new JButton("");
		button_149.setBorderPainted(false);
		button_149.setBackground(new Color(255, 250, 205));
